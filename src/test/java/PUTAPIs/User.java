...
//POJO Class
@JsonInclude(JsonInclude.Include.NON_NULL) //With this annotation we can ignore the null values. Also, While using Builder pattern, it doesn't know which constructor to call, so it can send null values for some variables. hence, we can use this annotation. It comes from jackson API and not Lombok
@Data
@AllArgsConstructor
@NoArgsConstructor
@Builder
